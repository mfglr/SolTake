...
import 'package:my_social_app/media/pages/select_directory_page/select_directory_page_texts.dart';
import 'package:my_social_app/media/pages/select_directory_page/widgets/asset_path_entity_widget.dart';
import 'package:my_social_app/media/pages/select_directory_page/widgets/camera_widget.dart';
import 'package:my_social_app/media/pages/select_directory_page/widgets/local_medias_widget/local_medias_widget.dart';
import 'package:my_social_app/media/pages/select_media_pagea/select_media_page.dart';
import 'package:my_social_app/media/pages/take_media_page/take_media_page.dart';
import 'package:my_social_app/media/services/media_reader.dart';
import 'package:my_social_app/media/wigets/media_slider/media_slider.dart';
...
class _SelectDirectoryPageState extends State<SelectDirectoryPage> {
  ...
  void takeMedia(){
    ...
    Navigator
      .of(context)
      .push<LocalMedia>(MaterialPageRoute(builder: (context) => const TakeMediaPage()))
      .then((media){
        if(media != null){
          _add([media]);
        }
          ...
          builder: (context) => SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: MediaSlider(medias: _medias,activeIndex: activeIndex,)
                ),
              ],
            )
          ),
