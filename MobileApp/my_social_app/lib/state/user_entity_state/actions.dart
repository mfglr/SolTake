...
class GetNextPageUserQuestionsIfNoPageAction extends redux.Action{
  final int offset;
  final int userId;
  const GetNextPageUserQuestionsIfNoPageAction({required this.offset,required this.userId});
}
@immutable
class GetNextPageUserQuestionsIfReadyAction extends redux.Action{
  final int offset;
  final int userId;
  const GetNextPageUserQuestionsIfReadyAction({required this.offset,required this.userId});
}
@immutable
class GetNextPageUserQuestionsAction extends redux.Action{
  final int offset;
  final int userId;
  const GetNextPageUserQuestionsAction({required this.offset,required this.userId});
}
@immutable
class AddNextPageUserQuestionsAction extends redux.Action{
  ...
  const AddNextPageUserQuestionsAction({required this.offset, required this.userId,required this.questionIds});
}
@immutable
class AddUserQuestionAction extends redux.Action{
  ...
  const AddUserQuestionAction({required this.offset, required this.userId,required this.questionId});
}
@immutable
class AddUserQuestionsPaginationAction extends redux.Action{
  final int offset;
  final int userId;
  const AddUserQuestionsPaginationAction({required this.offset, required this.userId});
}
@immutable
class AddUserQuestionsPaginationSuccessAction extends redux.Action{
  final int offset;
  final int userId;
  const AddUserQuestionsPaginationSuccessAction({required this.offset, required this.userId});
}
