...
UserEntityState cancelFollowRequest(UserEntityState oldState, Action action)
...
Reducer<UserEntityState> userEntityStateReducers = combineReducers<UserEntityState>([
  ...
  TypedReducer<UserEntityState,FollowRequestSuccessfullyCancelledAction>(cancelFollowRequest).call,
]);