...
UserEntityState getNextPageQuestionsReducer(UserEntityState prev,GetNextPageUserQuestionsAction action)
  => prev.startLoadinQuestions(action.offset,action.userId);
UserEntityState addNextPageQuestionsReducer(UserEntityState prev,AddNextPageUserQuestionsAction action)
  => prev.addNextPageQuestions(action.offset, action.userId,action.questionIds);
UserEntityState addQuestionReducer(UserEntityState prev, AddUserQuestionAction action)
  => prev.addQuestion(action.offset, action.userId, action.questionId);
UserEntityState addQuestionPagination(UserEntityState prev,AddUserQuestionsPaginationSuccessAction action)
  => prev.addQuestionPagination(action.offset, action.userId);
...
Reducer<UserEntityState> userEntityStateReducers = combineReducers<UserEntityState>([
  ...
  TypedReducer<UserEntityState,AddUserQuestionsPaginationSuccessAction>(addQuestionPagination).call,
