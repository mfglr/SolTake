...
class UserEntityState extends EntityState<UserState>{
  ...
  UserEntityState startLoadinQuestions(int offset, int userId)
    => UserEntityState(entities: updateOne(entities[userId]!.startLoadingQuestions(offset)));
  UserEntityState addNextPageQuestions(int offset, int userId, Iterable<int> questions)
    => UserEntityState(entities: updateOne(entities[userId]!.addNextPageQuestions(offset, questions)));
  UserEntityState addQuestion(int offset, int userId,int questionId)
    => UserEntityState(entities: updateOne(entities[userId]!.addQuestion(offset,questionId)));
  UserEntityState addQuestionPagination(int offset,int userId)
    => UserEntityState(entities: updateOne(entities[userId]!.addQuestionPagination(offset)));
