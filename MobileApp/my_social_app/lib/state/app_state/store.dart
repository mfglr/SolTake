...
final store = Store(
  ...
  initialState: AppState(
    ...
    examEntityState: const ExamEntityState(containers: {}, isLast: false,isLoading: false),
    subjectEntityState: const SubjectEntityState(containers: {}),
    topicEntityState: const TopicEntityState(containers: {}),
    solutionEntityState: const SolutionEntityState(containers: {}),
    homePageState: HomePageState(questions: Pagination.init(questionsPerPage,true)),
    commentEntityState: const CommentEntityState(containers: {}),
    commentUserLikeEntityState: const CommentUserLikeEntityState(containers: {}),
    createCommentState: const CreateCommentState(question: null, solution: null, comment: null, content: "", hintText: ""),
    notificationEntityState: const NotificationEntityState(containers: {},isUnviewedNotificationsLoaded: false,isLast: false,lastId: null),
    messageEntityState: const MessageEntityState(containers: {}),
    ...
    followEntityState: const FollowEntityState(containers: {}),
    questionEntityState: const QuestionEntityState(containers: {}),
