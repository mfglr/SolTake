...
SolutionsState markSolutionAsCorrectReducer(SolutionsState prev, MarkSolutionAsCorrectSuccessAction action)
  => prev.markAsCorrect(action.solution);
SolutionsState markSolutionAsIncorrectReducer(SolutionsState prev, MarkSolutionAsIncorrectSuccessAction action)
...
Reducer<SolutionsState> solutionsReducer = combineReducers<SolutionsState>([
  ...
  TypedReducer<SolutionsState,MarkSolutionAsCorrectSuccessAction>(markSolutionAsCorrectReducer).call,
  TypedReducer<SolutionsState,MarkSolutionAsIncorrectSuccessAction>(markSolutionAsIncorrectReducer).call,
  ...
  TypedReducer<SolutionsState,NextQuestionCorrectSolutionsFailedAction>(nextQuestionCorrectSolutionsFailedReducer).call,
  ...
  TypedReducer<SolutionsState,RefreshQuestionCorrectSolutionsFailedAction>(refreshQuestionCorrectSolutionsFailedReducer).call,
  //question correct solutions;
