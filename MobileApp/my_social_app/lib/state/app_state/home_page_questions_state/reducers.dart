...
Pagination<int,Id<int>> prevQuestionsReducer(Pagination<int,Id<int>> prev,PrevHomePageQuestionsAction action)
...
Reducer<Pagination<int,Id<int>>> homePageQuestionsReducers = combineReducers<Pagination<int,Id<int>>>([
  ...
  TypedReducer<Pagination<int,Id<int>>,PrevHomePageQuestionsAction>(prevQuestionsReducer).call,
