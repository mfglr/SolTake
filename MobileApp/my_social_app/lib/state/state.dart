...
class AppState{
  ...
  //Select solutions
  Iterable<SolutionState> selectQuestionSolutions(int offset,int questionId)
    => questionEntityState.entities[questionId]!.solutionPaginations.selectPagination(offset).ids.map((e) => solutionEntityState.entities[e]!);
  ...
  Iterable<QuestionState> selectUserQuestions(int offset,int userId)
    => userEntityState.entities[userId]!.questionPaginations.selectIds(offset).map((e) => questionEntityState.entities[e]!);
  Iterable<QuestionState> get selectSearchQuestions
    => searchState.questions.ids.map((e) => questionEntityState.entities[e]!);
    
  //Select comments
  Iterable<CommentState> getQuestionComments(int offset, int questionId)
    => questionEntityState.entities[questionId]!.commentPaginations.selectPagination(offset).ids.map((e) => commentEntityState.entities[e]!);
