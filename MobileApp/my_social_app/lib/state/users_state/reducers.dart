...
//questions
UsersState uploadQuestionReducer(UsersState prev, UploadQuestionAction action) =>
...
Reducer<UsersState> usersReducer = combineReducers<UsersState>([
  //quesitons
  TypedReducer<UsersState,UploadQuestionAction>(uploadQuestionReducer).call,
