...
class SolutionsState {
  ...
  SolutionsState loading(int solutionId) =>
    _optional(
      newSolutions: solutions.create(solutionId)
    );
  SolutionsState success(SolutionState solution) =>
    _optional(
      newSolutions: solutions.loadSuccess(solution.id, solution)
    );
  SolutionsState failed(int solutionId) =>
    _optional(
      newSolutions: solutions.loadFailed(solutionId)
    );
  ...
  SolutionsState markAsCorrect(SolutionState solution) =>
    _optional(
      newSolutions: solutions.update(solution.id, solution.markAsCorrect()),
    );
  SolutionsState markAsIncorrect(SolutionState solution) =>
    _optional(
      newSolutions: solutions.update(solution.id, solution.markAsIncorrect()),
    );
  //solutions
