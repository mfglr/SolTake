...
CreateSolutionState addImageReducer(CreateSolutionState prev,AddSolutionImageAction action)
...
Reducer<CreateSolutionState> createrSolutionReducers = combineReducers<CreateSolutionState>([
  ...
  TypedReducer<CreateSolutionState,AddSolutionImageAction>(addImageReducer).call,
