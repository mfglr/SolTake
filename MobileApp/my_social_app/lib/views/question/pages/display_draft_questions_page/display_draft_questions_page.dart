...
import 'package:my_social_app/views/question/pages/display_draft_questions_page/display_draft_questions_page_texts.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StoreConnector<AppState,Iterable<QuestionState>>(
        onInit: (store) => getNextPageIfNoPage(store, getDraftQuestions(store), const NextDraftQuestionsAction()),
