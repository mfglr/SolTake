...
class DisplaySolutionsPage extends StatefulWidget {
  ...
  @override
  State<DisplaySolutionsPage> createState() => _DisplaySolutionsPageState();
}

class _DisplaySolutionsPageState extends State<DisplaySolutionsPage> {
  ...
  void _onScrollBottom() =>
    _scrollController.onScrollBottom((){
      ...
      getNextEntitiesIfReady(
        store,
        selectQuestionSolutions(store, widget.questionId),
        NextQuestionSolutionsAction(questionId: widget.questionId)
      );
    });
      ...
      child: RefreshIndicator(
        onRefresh: (){
          ...
          refreshEntities(
            store,
            selectQuestionSolutions(store, widget.questionId),
            RefreshQuestionSolutionsAction(questionId: widget.questionId)
          );
          return onQuestionSolutionsLoaded(store, widget.questionId);
        },
        child: StoreConnector<AppState, ContainerPagination<int, SolutionState>>(
          ...
          converter: (store) => selectQuestionSolutions(store, widget.questionId),
