  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: (){
        ...
        refreshEntities(
          store,
          selectQuestionSolutionsPagination(store, questionId),
          RefreshQuestionSolutionsAction(questionId: questionId)
        );
        return onQuestionSolutionsLoaded(store, questionId);
      },
      child: StoreConnector<AppState, (KeyPagination<int>, Iterable<SolutionState>)>(
        ...
        converter: (store) => selectQuestionSolutionsAndPagination(store, questionId),
        builder: (context, data) => SolutionAbstractItems(
          data: data,
          noItems: const NoQuestionSolutions(),
          onTap: (solutionId) =>
            Navigator
              .of(context)
              .push(
