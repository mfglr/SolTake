...
class SolutionContainerAbstractWidget extends StatelessWidget {
  final EntityContainer<int, SolutionState> container;

  const SolutionContainerAbstractWidget({
    super.key,
    required this.container,
  });

  Media get _getMedia => container.entity!.isCreatedByAI ? container.entity!.aiImage! : container.entity!.medias.first;
