...
import 'package:my_social_app/custom_packages/media/wigets/media_scroller_widget/media_scroller_widget.dart';
...
class _SolutionVideoPageSliderState extends State<SolutionVideoPageSlider> {
  ...
  Widget build(BuildContext context) {
    return MediaScrollerWidget(
      medias: widget.solutions.map((e) => e.medias.where((e) => e.type == MultimediaType.video).first),
