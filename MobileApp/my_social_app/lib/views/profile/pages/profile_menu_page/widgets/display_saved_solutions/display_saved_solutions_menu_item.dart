...
import 'package:my_social_app/views/profile/pages/profile_menu_page/widgets/display_saved_solutions/display_saved_solutions_menu_item_texts.dart';
    ...
    return LanguageWidget(
      child: (language) => ProfileMenuItem(
        ...
        onPressed: () => 
          Navigator
            .of(context)
            .push(MaterialPageRoute(builder: (context) => const DisplayAbstractSavedSolutionsPage()))
      ),
    );
  }
}