...
import 'package:my_social_app/custom_packages/media/pages/select_media_pagea/select_media_page_texts.dart';
import 'package:my_social_app/custom_packages/media/pages/select_media_pagea/widgets/asset_entities_widget.dart';
          ...
          TextButton(
            onPressed: () async {
              ...
              for(var e in _selectedEntities){
                ...
                final dimention = await DimentionCalculator.calculate(file.path);
                if(e.type == AssetType.image){
                  list.add(LocalImage(file: file, dimention: dimention));
                }
                else{
                  list.add(LocalVideo(file: file, dimention: dimention));
                }
              }
              if(context.mounted){
                Navigator
