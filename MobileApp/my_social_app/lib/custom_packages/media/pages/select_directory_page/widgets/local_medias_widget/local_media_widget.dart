...
import 'package:my_social_app/custom_packages/media/pages/select_directory_page/widgets/local_medias_widget/local_image_widget.dart';
import 'package:my_social_app/custom_packages/media/pages/select_directory_page/widgets/local_medias_widget/local_video_widget.dart';
          ...
          Builder(
            builder: (context){
              if(localMedia is LocalImage){
                ...
                return LocalVideoWidget(media: localMedia as LocalVideo);
              }
            }
          ),
          GestureDetector(
