...
class MessageService{
  ...
  Future<Iterable<Message>> getMessagesByConversationId(int conversationId,int? lastId,int? take) async {
    final url = _appClient.generatePaginationUrl("$messageController/$getMessagesByConversationIdEndpoint", lastId, take);
