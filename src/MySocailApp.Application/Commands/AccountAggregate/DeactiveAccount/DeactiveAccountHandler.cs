...
{
    public class DeactiveAccountHandler(IAppUserWriteRepository userRepository, IUnitOfWork unitOfWork, IAccountAccessor accountAccessor) : IRequestHandler<DeactiveAccountDto>
    {
