...
{
    public class CreateNotificationOnCommentCreated(IQuestionReadRepository questionRepository, ISolutionReadRepository solutionRepository, ICommentReadRepository commentRepository, INotificationWriteRepository notificationRepository, IUnitOfWork unitOfWork) : IDomainEventConsumer<CommentCreatedDomainEvent>
    {
