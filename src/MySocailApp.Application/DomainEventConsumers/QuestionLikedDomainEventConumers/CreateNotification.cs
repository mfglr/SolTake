...
{
    public class CreateNotification(INotificationWriteRepository notificationRepository, IUnitOfWork unitOfWork) : IDomainEventConsumer<QuestionLikedDomainEvent>
    {
