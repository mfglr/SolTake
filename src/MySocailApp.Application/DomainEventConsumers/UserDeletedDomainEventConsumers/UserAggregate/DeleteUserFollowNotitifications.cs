...
{
    public class DeleteUserFollowNotitifications(IUnitOfWork unitOfWork,IAppUserWriteRepository userWriteRepository) : IDomainEventConsumer<UserDeletedDomainEvent>
    {
        ...
        {
            await _userWriteRepository.DeleteFollowNotificationsByUserId(notification.User.Id, cancellationToken);
