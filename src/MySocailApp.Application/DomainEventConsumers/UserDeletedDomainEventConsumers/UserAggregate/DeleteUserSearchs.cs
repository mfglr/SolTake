...
{
    public class DeleteUserSearchs(IUnitOfWork unitOfWork, IUserUserSearchWriteRepository userSearchWriteRepository) : IDomainEventConsumer<UserDeletedDomainEvent>
    {
