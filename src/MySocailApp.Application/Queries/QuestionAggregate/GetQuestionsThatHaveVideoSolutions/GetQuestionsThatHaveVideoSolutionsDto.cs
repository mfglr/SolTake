...
{
    public class GetQuestionsThatHaveVideoSolutionsDto(int? examId, int? subjectId, int? topicId, int? offset, int take, bool isDescending) : Page(offset, take, isDescending), IRequest<List<QuestionResponseDto>>
    {
