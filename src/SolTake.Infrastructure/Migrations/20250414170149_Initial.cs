        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SolutionId = table.Column<int>(type: "int", nullable: true),
                    SolutionContent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SolutionMedia_ContainerName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SolutionMedia_BlobName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SolutionMedia_BlobNameOfFrame = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SolutionMedia_Size = table.Column<long>(type: "bigint", nullable: true),
                    SolutionMedia_Height = table.Column<double>(type: "float", nullable: true),
                    SolutionMedia_Width = table.Column<double>(type: "float", nullable: true),
                    SolutionMedia_Duration = table.Column<double>(type: "float", nullable: true),
                    SolutionMedia_MultimediaType = table.Column<int>(type: "int", nullable: true),
                    RepliedId = table.Column<int>(type: "int", nullable: true),
                    RepliedContent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SolutionVoteType = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
