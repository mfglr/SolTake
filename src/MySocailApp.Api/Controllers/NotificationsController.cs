...
namespace MySocailApp.Api.Controllers
{
    ...
    public class NotificationsController(IMediator mediator) : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<List<NotificationResponseDto>> GetNotifications([FromQuery] int? lastId, [FromQuery] int? take, CancellationToken cancellationToken)
            => await _mediator.Send(new GetNotificationsDto(lastId, take), cancellationToken);
