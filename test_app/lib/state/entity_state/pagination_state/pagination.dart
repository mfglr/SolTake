...
import 'package:test_app/state/entity_state/pagination_state/page.dart' as pagination;
...
class Pagination<K extends Comparable, V extends Entity<K>>{
  ...
  final Future<Iterable<V>> Function(pagination.Page<K> page, {dynamic parameters}) callback;
  ...
  factory Pagination.init(int recordsPerPage,bool isDescending,Future<Iterable<V>> Function(pagination.Page<K> page, {dynamic parameters}) callback)
    => Pagination<K,V>(
        isLast: false,
        loadingNext: false,
        loadingPrev: false,
